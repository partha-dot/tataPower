  ...
  const apiUrl = this.api.baseUrl;
    ...
    saveProduct() {
      ...
      this.device='';
        ...
        this.productDialog = false;
        this.http.post(apiUrl+'/client/report/daily_report', credentials,{ headers }).subscribe(
          (response) => {
            this.spinner=false;
            console.log(response);
            this.data1=response
    ...
    // exportToExcel() {
    //   const data: any[] = []; // Your table data arra
    //   // Add header row
    //   const header = ['Sl No.', 'DATE', 'Min Temperature (°C)','Max Temperature (°C)','Avg Temperature (°C)','Min Humidity (%)','Max Humidity (%)','Avg Humidity (%)',
    // 'Min Rainfall (m/s)','Max Rainfall (m/s)','Avg Rainfall (m/s)', 'Min Rainfall Cumulative(m/s)','Max Rainfall Cumulative(m/s)','Avg Rainfall Cumulative(m/s)',
    // 'Min Solar Radiation (W/m2)','Max Solar Radiation (W/m2)','Avg Solar Radiation (W/m2)','Min ATM Pressure (mbar)','Max ATM Pressure (mbar)','Avg ATM Pressure (mbar)',
    //   'Wind Direction (degree)', 'Wind Speed (km/h)','Signal Strength (%)'];
    //   data.push(header);
    ...
    //         this.excelData[i].min_temperature.toFixed(2),
    //         this.excelData[i].max_temperature.toFixed(2),
    //         this.excelData[i].avg_temperature.toFixed(2),

    //         this.excelData[i].min_humidity.toFixed(2),
    //         this.excelData[i].max_humidity.toFixed(2),
    //         this.excelData[i].avg_humidity.toFixed(2),

    //         this.excelData[i].min_rainfall.toFixed(2),
    //         this.excelData[i].max_rainfall.toFixed(2),
    //         this.excelData[i].avg_rainfall.toFixed(2),

    //         this.excelData[i].min_rainfall_cumulative.toFixed(2),
    //         this.excelData[i].max_rainfall_cumulative.toFixed(2),
    //         this.excelData[i].avg_rainfall_cumulative.toFixed(2),

    //         this.excelData[i].min_solar_radiation.toFixed(2),
    //         this.excelData[i].max_solar_radiation.toFixed(2),
    //         this.excelData[i].avg_solar_radiation.toFixed(2),

    //         this.excelData[i].min_atm_pressure.toFixed(2),
    //         this.excelData[i].max_atm_pressure.toFixed(2),
    //         this.excelData[i].avg_atm_pressure.toFixed(2),

    //         this.excelData[i].wind_direction.toFixed(2),
    //         this.excelData[i].wind_speed.toFixed(2),
    //         this.excelData[i].tw.toFixed(2),
    //       ];
    //       data.push(rowData);
    ...
    exportToExcel() {
        ...
        this.saveAsExcelFile(excelBuffer, 'weather_data_daily');
      }
